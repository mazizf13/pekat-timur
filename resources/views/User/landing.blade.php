...
<section class="header">
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Layanan Pengaduan Masyarakat Perumahan Rungkut Asri Timur</h2>
        <p class="italic text-white mb-5">Sampaikan langsung laporan Anda kepada pengelola pereumahan</p>
    </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2024 <span><a href="https://instagram.com/mazizf_/" target="_blank">aziz</a></span> • Inspired by Ihsanfrr • All rights reserved</p>
    </div>
</div>
{{-- Modal --}}
